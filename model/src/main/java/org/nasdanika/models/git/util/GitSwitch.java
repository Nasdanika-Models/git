...
public class GitSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case GitPackage.REPOSITORY: {
				Repository repository = (Repository)theEObject;
				T result = caseRepository(repository);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case GitPackage.REFERENCE: {
				Reference reference = (Reference)theEObject;
				T result = caseReference(reference);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case GitPackage.REMOTE: {
				Remote remote = (Remote)theEObject;
				T result = caseRemote(remote);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case GitPackage.GIT_OBJECT: {
				GitObject gitObject = (GitObject)theEObject;
				T result = caseGitObject(gitObject);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case GitPackage.TAG: {
				...
				if (result == null) result = caseReference(tag);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case GitPackage.TREE: {
				Tree tree = (Tree)theEObject;
				T result = caseTree(tree);
				if (result == null) result = caseGitObject(tree);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case GitPackage.BLOB: {
				Blob blob = (Blob)theEObject;
				T result = caseBlob(blob);
				if (result == null) result = caseGitObject(blob);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case GitPackage.COMMIT: {
				Commit commit = (Commit)theEObject;
				T result = caseCommit(commit);
				if (result == null) result = caseGitObject(commit);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
	 ...
	 * @generated
	 */
	public T caseGitObject(GitObject object) {
		return null;
	}
